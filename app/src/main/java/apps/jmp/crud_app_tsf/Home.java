...
import apps.jmp.crud_app_tsf.Fragments.*;
import apps.jmp.crud_app_tsf.PersonDetails.PersonalDetailsData;
import apps.jmp.crud_app_tsf.Pic.StatusMessage;
import apps.jmp.crud_app_tsf.ProfDetails.ProfessionalDetailsData;
import apps.jmp.crud_app_tsf.UID.*;
import apps.jmp.crud_app_tsf.Retro.UserService;
import apps.jmp.crud_app_tsf.Retro.*;
import static apps.jmp.crud_app_tsf.LoginActivity.MY_PREF;
        ...
        call.enqueue(new Callback<ProfessionalDetailsData>() {
            ...
            public void onResponse(Call<ProfessionalDetailsData> call, Response<ProfessionalDetailsData> response) {
                if(response.body() != null) {
                    ...
                    Toast.makeText(Home.this, "Professional Details Response Empty", Toast.LENGTH_LONG).show();
                }
            }
            @Override
            public void onFailure(Call<ProfessionalDetailsData> call, Throwable t) {
                Toast.makeText(Home.this, "Response Failed: " + t.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
        ...
        call.enqueue(new Callback<PersonalDetailsData>() {
            ...
            public void onResponse(Call<PersonalDetailsData> call, Response<PersonalDetailsData> response) {
                if(response.body() != null) {
                    ...
                    Toast.makeText(Home.this, "Personal Details Response Empty", Toast.LENGTH_LONG).show();
                }
            }
            @Override
    ...
    private void deleteProfessionalData() {
        ...
        call.enqueue(new Callback<StatusMessage>() {
            ...
            public void onFailure(Call<StatusMessage> call, Throwable t) {
                Toast.makeText(Home.this, "Delete Failed: " + t.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
